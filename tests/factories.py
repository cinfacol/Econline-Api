...
class ProfileFactory(factory.django.DjangoModelFactory):
    ...
    address_line_1 = factory.LazyAttribute(lambda x: faker.sentence(nb_words=5))
    address_line_2 = factory.LazyAttribute(lambda x: faker.sentence(nb_words=5))
    ...
    verified = factory.LazyAttribute(lambda x: f"unverified")
    country = factory.LazyAttribute(lambda x: faker.country_code())
    departamento = factory.LazyAttribute(lambda x: faker.text(max_nb_chars=36))
    zipcode = factory.LazyAttribute(lambda x: faker.text(max_nb_chars=12))
