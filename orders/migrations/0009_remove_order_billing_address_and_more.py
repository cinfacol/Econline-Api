# Generated by Django 5.1.1 on 2024-11-07 04:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0008_alter_orderitem_name_alter_orderitem_price'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='order',
            name='status',
            field=models.CharField(choices=[('PENDING', 'Pending'), ('COMPLETED', 'Completed'), ('SHIPPED', 'Shipped'), ('DELIVERED', 'Delivered'), ('CANCELLED', 'Cancelled')], default='PENDING', max_length=50, verbose_name='Status'),
        ),
    ]
